...
| WU13 | ✅ done | — | ~80 | Mount backoffice at `/backoffice/`. Nginx rewrite (strip `/backoffice/` prefix) + Next.js basePath + api-client base URL. 148/148 tests verde (no regression). |
